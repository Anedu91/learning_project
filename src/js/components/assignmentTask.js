export const assignmentTask = (assigment, index) => {
  ...
  return `
        ...
        <button class="card__btn" type="button" data-bs-toggle="collapse" data-bs-target="#task${assigment.id}" aria-expanded="false" aria-controls="task${index}">
          ...
          <div class="card-body">
            <div class="card__action">
              ...
              <div class="mt-3 card__container">
                ...
                <span class="icon-check font-icon"></span> 
                </button>
              </div>
              <div class="mt-3">
